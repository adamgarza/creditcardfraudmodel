...
# ITS490 PROJECT
# FALL 2018
# PLEASE NOTE THAT AS THIS PROJECT EVOLVES - SECTIONS OF THE CODE ARE NO LONFER USED. (I.E, THE TRAIN AND TEST SETS ARE SPLIT USING WEKA UI)
# ---------------------------------------------------------------------------------
...
# DATA PREPROCESS
    ...
    # 8. CALCULATE RATIO FOR LOGIT VS FRAUD
        ...
        # LEGIT WEIGHTs WILL BE IMPLEMENTED FOR ORIGINAL DATASET
    # 9. LEGIT WEIGHTS ARE APPLIED TO UNDERREPRESENTED CLASS
